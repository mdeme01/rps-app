...
class App extends React.Component {
    ...
    render() {
        return [
            <Header key="header" score={this.state.score} />,
            <main key="main" className="grid place-content-center">
                ...
                <div className={`${this.state.resultDisplayed ? 'grid' : 'hidden'} gap-3`}>
                    ...
                    <div
                        className={`${
                            this.state.playerDisplayed ? 'block' : 'hidden'
                    ...
                    <div
                        className={`${
                            !this.state.houseDisplayed ? 'row-span-2' : 'self-center'
                    ...
                    <div
                        className={`${
                            this.state.houseDisplayed ? 'block' : 'hidden'
