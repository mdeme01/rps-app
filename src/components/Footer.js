    ...
    return (
        <footer className="grid grid-cols-1 gap-3 place-content-center self-end justify-self-center w-full mb-5 text-center">
            <button
                ...
                } border-solid border-2 border-white hover:bg-white hover:text-textDark uppercase pt-2 pb-2 pl-10 pr-10 rounded-lg tracking-widest self-center justify-self-center w-auto md:justify-self-end md:mr-5`} // absolute bottom-5 right-5
            >
                Rules
            </button>
            ...
            <div
                ...
                } bg-white rounded-md p-8 grid-cols-1 z-30 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full md:grid-cols-2 md:w-auto md:h-auto`}
            >
