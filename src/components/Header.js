...
function Header(props) {
    return (
        <header className="grid grid-rows-1 grid-cols-3 place-content-center gap-3 rounded-md border-2 border-solid border-white p-4 m-4 mt-10 self-start justify-self-center">
