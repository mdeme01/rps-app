...
function Header(props) {
    return (
        <header className="grid grid-rows-1 grid-cols-2 place-content-center gap-3 rounded-md border-2 border-solid border-white p-5 w-auto self-start justify-self-center mt-10">
